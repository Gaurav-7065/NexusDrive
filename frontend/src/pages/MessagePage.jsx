...
const CreateNoticeForm = () => {
  ...
  return (
    <div className="w-full bg-transparent p-4 transition-colors duration-200">
      ...
      <div className={`w-full max-w-4xl mx-auto border rounded-2xl p-8 shadow-sm transition-colors duration-200 ${isDark ? 'bg-[#1a1a1a] border-gray-800 text-white' : 'bg-white border-gray-200 text-gray-900'
        }`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 space-y-2">
              ...
              <input
                ...
                className={`w-full text-sm rounded-xl p-3 border outline-none transition-all ${isDark
            ...
            <div className="space-y-2">
              ...
              <div className={`grid grid-cols-3 gap-1 p-1 border rounded-xl h-[46px] items-center ${isDark ? 'bg-[#0f0f0f] border-gray-800' : 'bg-gray-100 border-gray-300'
                }`}>
                ...
                <button
                  ...
                  className={`text-xs font-medium py-2 rounded-lg transition-all ${priority === 'Low'
                ...
                <button
                  ...
                  className={`text-xs font-medium py-2 rounded-lg transition-all ${priority === 'Medium'
                ...
                <button
                  ...
                  className={`text-xs font-medium py-2 rounded-lg transition-all ${priority === 'High'
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className={`w-full text-sm rounded-xl p-4 border outline-none resize-none leading-relaxed transition-all ${isDark
                  ? 'bg-[#0f0f0f] border-gray-800 text-gray-200 placeholder:text-gray-700 focus:ring-2 focus:ring-indigo-500/50'
                  : 'bg-gray-50 border-gray-300 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-500/30'
                }`}
              required
          ...
          <div className={`p-3.5 rounded-xl border flex items-center gap-3 text-xs transition-all duration-200 ${priority === 'High'
          ...
          <div className={`pt-4 border-t flex flex-col sm:flex-row justify-between items-center gap-4 ${isDark ? 'border-gray-800/60' : 'border-gray-100'}`}>
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
              <button
                type="button"
                className={`px-4 py-2.5 text-xs font-medium border rounded-xl transition-all ${isDark ? 'border-gray-700 text-gray-300 hover:bg-gray-800/40' : 'border-gray-300 text-gray-700 hover:bg-gray-50'
                  }`}
              >
                Save Draft
              </button>
              <button type="submit"
                ...
                className="px-5 py-2.5 text-xs font-medium bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl flex items-center gap-2 shadow-sm transition-all active:scale-95">
                <Send size={13} />
