                    ...
                    <form className="mt-5 flex flex-col gap-3.5">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center border border-slate-200/80 focus-within:border-violet-500 rounded-xl px-3 py-2 bg-slate-50/50 transition-colors">
                                ...
                                <input type="password" placeholder="Create a password" className="ml-2.5 text-xs font-medium w-full bg-transparent outline-none text-slate-700" required />
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-2 gap-3 mt-0.5 animate-fadeIn">
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <div className="flex items-center border border-slate-200/80 focus-within:border-violet-500 rounded-xl px-3 py-2 bg-slate-50/50 transition-colors">
                                        ...
                                        <input type="number" step="0.01" min="0" max="10" placeholder="0.00" className="ml-2.5 text-xs font-medium w-full bg-transparent outline-none text-slate-700" required />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <div className="flex items-center border border-slate-200/80 focus-within:border-violet-500 rounded-xl px-3 py-2 bg-slate-50/50 transition-colors">
                                        ...
                                        <input type="text" placeholder="e.g. 21CS01" className="ml-2.5 text-xs font-medium w-full bg-transparent outline-none text-slate-700" required />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col gap-1 col-span-2">
                                    ...
                                    <div className="flex items-center border border-slate-200/80 focus-within:border-violet-500 rounded-xl px-3 bg-slate-50/50 transition-colors h-9">
                                        ...
                                        <select className="ml-2 w-full bg-transparent outline-none text-xs font-bold text-slate-600 cursor-pointer h-full">
